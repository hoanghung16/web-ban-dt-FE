...
const AdminProducts = () => {
  ...
  // Lọc sản phẩm theo search term và category
  const filteredProducts = products.filter(product => {
    ...
    const matchesCategory = !categoryFilter || product.categoryid?.toString() === categoryFilter || product.category?.id?.toString() === categoryFilter;
